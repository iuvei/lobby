...
import { SetCurrentBetData, SetBetData, SetOrderConfirm } from '../../redux/actions'
import BallGrid from './NewBallGrid.jsx'
import SelectArea from './NewSelectArea.jsx'

class JiaoChaPeng extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
  ...
  render() {
    const { currentLottery } = this.props
    return (
...
export default connect(mapStateToProps, mapDispatchToProps)(JiaoChaPeng)
